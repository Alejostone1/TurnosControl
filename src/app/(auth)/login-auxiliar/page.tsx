  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if ((session?.user as any)?.userType !== "auxiliar") {
        toast.error("Esta pantalla es exclusiva para Auxiliares.")
        ...
        <div className="flex flex-col lg:flex-row min-h-[520px]">
          ...
          <div className="flex-1 flex flex-col justify-center p-6 sm:p-10">
            ...
            <div className="flex items-center gap-3 mb-6 lg:hidden">
              ...
              <div>
                <h1 className="text-lg font-bold text-gray-900">Portal Auxiliar</h1>
                <p className="text-xs text-gray-500">Acceso para auxiliares</p>
              </div>
            </div>

            <h2 className="text-2xl sm:text-3xl font-bold text-gray-800 mb-1">Acceso Auxiliar</h2>
            <p className="text-gray-500 text-sm mb-7">Ingresa tus credenciales de auxiliar</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div className="space-y-1.5">
                ...
                <Input
                  id="email"
                  type="email"
                  placeholder="auxiliar@empresa.com"
                  value={email}
