...
interface SidebarLiquidadorProps {
  mobileOpen?: boolean
  onMobileClose?: () => void
}

const navigation = [
  { name: "Inicio",          href: "/dashboard/liquidador",                icon: LayoutDashboard },
  { name: "Programación",    href: "/dashboard/liquidador/programacion",   icon: Calendar },
  { name: "Liquidación",     href: "/dashboard/liquidador/liquidacion",    icon: Calculator },
  { name: "Empleados",       href: "/dashboard/liquidador/empleados",      icon: Users },
  { name: "Reportes",        href: "/dashboard/liquidador/reportes",       icon: FileText },
]

export function SidebarLiquidador({ mobileOpen = false, onMobileClose }: SidebarLiquidadorProps) {
        ...
        <div className="flex items-center justify-between p-4 border-b min-h-[65px]">
          <div className={cn("min-w-0 flex-1 mr-2", isCollapsed && "md:hidden")}>
            <div className="flex items-center gap-1.5 mb-0.5">
              ...
              <span className="text-[10px] font-semibold text-emerald-600 uppercase tracking-wide">Liquidador</span>
            </div>
